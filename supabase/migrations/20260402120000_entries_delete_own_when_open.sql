-- Runners may delete (withdraw from) their own entries while registration is still open
-- for that distance (distance pr_cutoff, else event pr_cutoff; null = still open).
