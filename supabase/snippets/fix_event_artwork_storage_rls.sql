-- =============================================================================
-- Run this if artwork upload fails with: "new row violates row-level security policy"
-- (You already ran the older apply_event_artwork.sql without the helper function.)
-- =============================================================================
